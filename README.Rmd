...
This is a basic example which shows you how to perform this sensitivity analysis on a simulated dataset.
This will generate a list containing data frame of sensitivity analysis and 3D scatter plot
...
Generated 3D scatter plot can't be viewed in R.
You can save it as a html object and open it with browser on your computer

``` r
saveWidget(sens_res$p_nie, file = "nie.html", selfcontained = TRUE)
saveWidget(sens_res$p_nde, file = "nde.html", selfcontained = TRUE)
```
You can also save the data frame into your computer and upload it to "http://127.0.0.1:5000/test" 
Reference
